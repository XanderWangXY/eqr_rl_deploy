#ifndef EQR_HARDWARE_INTERFACE_HPP_
#define EQR_HARDWARE_INTERFACE_HPP_

#include "robot_interface.h"
#include "ehr_hardware.h"
#include <memory>

class EQRHardwareInterface : public RobotInterface {
private:
...
public:
    EQRHardwareInterface(const std::string& robot_name)
